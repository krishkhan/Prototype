   ...
   public class Server
    {
        ...
        public delegate void SocketConnectionEventHandler(Object sender, SocketConnection conn, byte[] rawdata);        
        public event SocketConnectionEventHandler OnNewDataReceived;
        ...
        private void ProcessReceive(SocketAsyncEventArgs e)
        {
            ...
            if (e.BytesTransferred > 0 && e.SocketError == SocketError.Success)
            {
                ...
                //NO:echo the data received back to the client
                ...
                //YES:robounce to uplayer the data receive 
                if (OnNewDataReceived != null)
                    OnNewDataReceived(this, new SocketConnection(token.Socket),e.Buffer.SubArray(e.Offset,e.BytesTransferred));
